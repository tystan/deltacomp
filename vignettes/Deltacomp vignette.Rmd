...
It is possible to extract predictions for the mean composition from the output of `predict_delta_comps()` using the following code:
...
```
This will provide a 1 line `data frame` that contains
...
- the 100*(1-alpha)% confidence intervals related to the predicted outcome ("lwr" and "upr", respetively)
